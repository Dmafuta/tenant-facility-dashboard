...
const PUBLIC_PATHS = ['/login', '/verify', '/resident-verify', '/tenant-reading', '/auth/magic', '/accept-invite', '/reset-password', '/pwa-only', '/api/backend/auth', '/api/auth', '/api/backend/settings/brand']
